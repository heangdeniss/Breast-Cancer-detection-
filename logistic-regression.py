...
if st.button("Predict"):
    ...
    # Additional details:
    st.markdown("""
    - **Logit(p)** represents the raw output of the logistic regression model.
    - **Probability of Malignancy** is the likelihood of the tumor being malignant, as predicted by the model.
    """)

# ------------------------------------------------
# 5) APP STYLING & FINAL DETAILS
# ------------------------------------------------
st.markdown("---")
